...
.repeat:
   ...
   cmp al, 0s  ; compare to zero to see if end of string. 
...
times 510-($-$$) db 0 ; fill remainder of boot sector with 0s up ; to byte 510.
dw 0xAA55   ; The standard PC boot signature of AA 55 ; is placed in bytes 511 and 512.
